...
class ContentPassTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSetMainContentViaStats()
    {
        $dom = new Crawler;
        $dom->addContent(<<<EOF
            <!DOCTYPE html>
...
EOF
    ...
    public function testSetMainContentViaArticleRole()
    {
        $dom = new Crawler;
        $dom->addContent(<<<EOF
            <!DOCTYPE html>
...
EOF
    ...
    public function testSetMainContentViaDocumentRole()
    {
        $dom = new Crawler;
        $dom->addContent(<<<EOF
            <!DOCTYPE html>
...
EOF
    ...
    public function testSetMainContentViaMainRole()
    {
        $dom = new Crawler;
        $dom->addContent(<<<EOF
            <!DOCTYPE html>
...
EOF
    ...
    public function testSetMainContentViaArticleTag()
    {
        $dom = new Crawler;
        $dom->addContent(<<<EOF
            <!DOCTYPE html>
